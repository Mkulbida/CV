...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://https://github.com/Mkulbida/CV/blob/main/resume.pdf)")
}
```
...
- <i class="fa fa-phone"></i> 1 (877) 7-MICKEY


More info {#more-info}
--------------------------------------------------------------------------------

Data visualization examples available at https://github.com/Mkulbida
